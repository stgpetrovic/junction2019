...
class PartialBasketItem(object):
    ...
    def __init__(self, multiplier=None, item=None, local_vars_configuration=None):  # noqa: E501
        """PartialBasketItem - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def multiplier(self):
        """Gets the multiplier of this PartialBasketItem.  # noqa: E501


        :return: The multiplier of this PartialBasketItem.  # noqa: E501
        :rtype: float
        """
    ...
    def multiplier(self, multiplier):
        """Sets the multiplier of this PartialBasketItem.


        :param multiplier: The multiplier of this PartialBasketItem.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
                multiplier is not None and multiplier < 0):  # noqa: E501
            raise ValueError("Invalid value for `multiplier`, must be a value greater than or equal to `0`")  # noqa: E501

        self._multiplier = multiplier

    @property
    def item(self):
        """Gets the item of this PartialBasketItem.  # noqa: E501


        :return: The item of this PartialBasketItem.  # noqa: E501
        :rtype: str
        """
        return self._item
    ...
    @item.setter
    def item(self, item):
        """Sets the item of this PartialBasketItem.


        :param item: The item of this PartialBasketItem.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
                item is not None and len(item) < 0):
            raise ValueError("Invalid value for `item`, length must be greater than or equal to `0`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartialBasketItem):
            return False
