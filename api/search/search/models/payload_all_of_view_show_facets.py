...
class PayloadAllOfViewShowFacets(object):
    ...
    def __init__(self, facets=None, limit=None, local_vars_configuration=None):  # noqa: E501
        """PayloadAllOfViewShowFacets - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def facets(self):
        """Gets the facets of this PayloadAllOfViewShowFacets.  # noqa: E501

        A string or an array of strings that determines which facets should be included in the response. Dot separated facets like `categories.id` can be matched with just a part of the full value like `categories`. All facets are returned by default.   # noqa: E501

        :return: The facets of this PayloadAllOfViewShowFacets.  # noqa: E501
        :rtype: list[str]
        """
        return self._facets
    ...
    def facets(self, facets):
        """Sets the facets of this PayloadAllOfViewShowFacets.

        A string or an array of strings that determines which facets should be included in the response. Dot separated facets like `categories.id` can be matched with just a part of the full value like `categories`. All facets are returned by default.   # noqa: E501

        :param facets: The facets of this PayloadAllOfViewShowFacets.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def limit(self):
        """Gets the limit of this PayloadAllOfViewShowFacets.  # noqa: E501

        Defines how many categories should be returned. Categories with most hits are prioritized. <br>Default value is 250.   # noqa: E501

        :return: The limit of this PayloadAllOfViewShowFacets.  # noqa: E501
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        """Sets the limit of this PayloadAllOfViewShowFacets.

        Defines how many categories should be returned. Categories with most hits are prioritized. <br>Default value is 250.   # noqa: E501

        :param limit: The limit of this PayloadAllOfViewShowFacets.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PayloadAllOfViewShowFacets):
            return False
