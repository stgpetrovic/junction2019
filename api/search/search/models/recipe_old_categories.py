...
class RecipeOldCategories(object):
    ...
    """
    openapi_types = {
        'category': 'list[RecipeOldCategory]'
    }
    ...
    def __init__(self, category=None, local_vars_configuration=None):  # noqa: E501
        """RecipeOldCategories - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def category(self):
        """Gets the category of this RecipeOldCategories.  # noqa: E501


        :return: The category of this RecipeOldCategories.  # noqa: E501
        :rtype: list[RecipeOldCategory]
        """
        return self._category

    @category.setter
    def category(self, category):
        """Sets the category of this RecipeOldCategories.


        :param category: The category of this RecipeOldCategories.  # noqa: E501
        :type: list[RecipeOldCategory]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecipeOldCategories):
            return False
