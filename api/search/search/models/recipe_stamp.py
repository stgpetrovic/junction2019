...
class RecipeStamp(object):
    ...
    def __init__(self, id=None, name=None, local_vars_configuration=None):  # noqa: E501
        """RecipeStamp - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this RecipeStamp.  # noqa: E501


        :return: The id of this RecipeStamp.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this RecipeStamp.


        :param id: The id of this RecipeStamp.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this RecipeStamp.  # noqa: E501


        :return: The name of this RecipeStamp.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RecipeStamp.


        :param name: The name of this RecipeStamp.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecipeStamp):
            return False
