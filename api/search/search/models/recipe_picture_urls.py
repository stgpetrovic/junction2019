...
class RecipePictureUrls(object):
    ...
    def __init__(self, id=None, normal=None, original=None, local_vars_configuration=None):  # noqa: E501
        """RecipePictureUrls - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this RecipePictureUrls.  # noqa: E501

        Id of the picture in Marsu  # noqa: E501

        :return: The id of this RecipePictureUrls.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this RecipePictureUrls.

        Id of the picture in Marsu  # noqa: E501

        :param id: The id of this RecipePictureUrls.  # noqa: E501
        :type: str
        """
    ...
    @property
    def normal(self):
        """Gets the normal of this RecipePictureUrls.  # noqa: E501

        Url for the default resolution picture  # noqa: E501

        :return: The normal of this RecipePictureUrls.  # noqa: E501
        :rtype: str
        """
        return self._normal
    ...
    def normal(self, normal):
        """Sets the normal of this RecipePictureUrls.

        Url for the default resolution picture  # noqa: E501

        :param normal: The normal of this RecipePictureUrls.  # noqa: E501
        :type: str
        """
    ...
    @property
    def original(self):
        """Gets the original of this RecipePictureUrls.  # noqa: E501

        Url for the original resolution picture. `w` and `h` parameters can be used to dynamically scale images.   # noqa: E501

        :return: The original of this RecipePictureUrls.  # noqa: E501
        :rtype: str
        """
    ...
    def original(self, original):
        """Sets the original of this RecipePictureUrls.

        Url for the original resolution picture. `w` and `h` parameters can be used to dynamically scale images.   # noqa: E501

        :param original: The original of this RecipePictureUrls.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecipePictureUrls):
            return False
