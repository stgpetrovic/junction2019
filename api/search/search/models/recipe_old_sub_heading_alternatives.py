...
class RecipeOldSubHeadingAlternatives(object):
    ...
    """
    openapi_types = {
        'ingredient': 'list[RecipeOldSubHeadingIngredient]'
    }
    ...
    def __init__(self, ingredient=None, local_vars_configuration=None):  # noqa: E501
        """RecipeOldSubHeadingAlternatives - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def ingredient(self):
        """Gets the ingredient of this RecipeOldSubHeadingAlternatives.  # noqa: E501


        :return: The ingredient of this RecipeOldSubHeadingAlternatives.  # noqa: E501
        :rtype: list[RecipeOldSubHeadingIngredient]
        """
        return self._ingredient

    @ingredient.setter
    def ingredient(self, ingredient):
        """Sets the ingredient of this RecipeOldSubHeadingAlternatives.


        :param ingredient: The ingredient of this RecipeOldSubHeadingAlternatives.  # noqa: E501
        :type: list[RecipeOldSubHeadingIngredient]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecipeOldSubHeadingAlternatives):
            return False
