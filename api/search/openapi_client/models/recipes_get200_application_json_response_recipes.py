...
class RecipesGet200ApplicationJsonResponseRecipes(object):
    ...
    """
    openapi_types = {
        'recipe': 'list[RecipesGet200ApplicationJsonResponseRecipesRecipe]'
    }
    ...
    def __init__(self, recipe=None, local_vars_configuration=None):  # noqa: E501
        """RecipesGet200ApplicationJsonResponseRecipes - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def recipe(self):
        """Gets the recipe of this RecipesGet200ApplicationJsonResponseRecipes.  # noqa: E501


        :return: The recipe of this RecipesGet200ApplicationJsonResponseRecipes.  # noqa: E501
        :rtype: list[RecipesGet200ApplicationJsonResponseRecipesRecipe]
        """
        return self._recipe

    @recipe.setter
    def recipe(self, recipe):
        """Sets the recipe of this RecipesGet200ApplicationJsonResponseRecipes.


        :param recipe: The recipe of this RecipesGet200ApplicationJsonResponseRecipes.  # noqa: E501
        :type: list[RecipesGet200ApplicationJsonResponseRecipesRecipe]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecipesGet200ApplicationJsonResponseRecipes):
            return False
