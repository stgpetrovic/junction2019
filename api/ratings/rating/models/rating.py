...
class Rating(object):
    ...
    @property
    def target_id(self):
        """Gets the target_id of this Rating.  # noqa: E501

        Id of the rated object. This id is the external id of the other service.   # noqa: E501

        :return: The target_id of this Rating.  # noqa: E501
        :rtype: str
        """
    ...
    def target_id(self, target_id):
        """Sets the target_id of this Rating.

        Id of the rated object. This id is the external id of the other service.   # noqa: E501

        :param target_id: The target_id of this Rating.  # noqa: E501
        :type: str
        """
    ...
    def target_namespace(self):
        """Gets the target_namespace of this Rating.  # noqa: E501
        ...
        :return: The target_namespace of this Rating.  # noqa: E501
        :rtype: str
        """
    ...
    def target_namespace(self, target_namespace):
        """Sets the target_namespace of this Rating.

        Namespace of the rating targets. This is provided because external services might have targets with collisioning IDs. For example service A might have product with id 1, and service B product with also id 1. This attribute makes it possible to separate those two products. All external service which use this API should agree on unique namespaces. For example all food products register could have namespace: `food-products`.   # noqa: E501

        :param target_namespace: The target_namespace of this Rating.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ratings(self):
        """Gets the ratings of this Rating.  # noqa: E501


        :return: The ratings of this Rating.  # noqa: E501
        :rtype: RatingRatings
        """
    ...
    def ratings(self, ratings):
        """Sets the ratings of this Rating.


        :param ratings: The ratings of this Rating.  # noqa: E501
        :type: RatingRatings
        """
    ...
    @property
    def comment(self):
        """Gets the comment of this Rating.  # noqa: E501

        Comment for the object. You must define either `rating`, `comment` or both.   # noqa: E501

        :return: The comment of this Rating.  # noqa: E501
        :rtype: str
        """
    ...
    def author_name(self):
        """Gets the author_name of this Rating.  # noqa: E501

        Name of the user who created the rating.  # noqa: E501

        :return: The author_name of this Rating.  # noqa: E501
        :rtype: str
        """
    ...
    def author_name(self, author_name):
        """Sets the author_name of this Rating.

        Name of the user who created the rating.  # noqa: E501

        :param author_name: The author_name of this Rating.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def author_role(self):
        """Gets the author_role of this Rating.  # noqa: E501

        Role of the rating's author.  # noqa: E501

        :return: The author_role of this Rating.  # noqa: E501
        :rtype: str
        """
    ...
    def author_role(self, author_role):
        """Sets the author_role of this Rating.

        Role of the rating's author.  # noqa: E501

        :param author_role: The author_role of this Rating.  # noqa: E501
        :type: str
        """
    ...
    def reply_requested(self, reply_requested):
        """Sets the reply_requested of this Rating.

        Does the author want a reply for their comment. When no comment is given, this should be `false`. Default: `false`.   # noqa: E501

        :param reply_requested: The reply_requested of this Rating.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def published(self):
        """Gets the published of this Rating.  # noqa: E501
        ...
        **Only for moderators+** Indicates if the rating has been published or not. If a rating has been published, it will show up in rating listings. Otherwise the item won't be returned from the API at all. This value is not returned for normal services. Only moderators and admin roles will see it. Trying to get unpublished rating directly will result to 404.   # noqa: E501
        ...
        :return: The published of this Rating.  # noqa: E501
        :rtype: bool
        """
    ...
    def published(self, published):
        """Sets the published of this Rating.

        **Only for moderators+** Indicates if the rating has been published or not. If a rating has been published, it will show up in rating listings. Otherwise the item won't be returned from the API at all. This value is not returned for normal services. Only moderators and admin roles will see it. Trying to get unpublished rating directly will result to 404.   # noqa: E501

        :param published: The published of this Rating.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def moderated(self):
        """Gets the moderated of this Rating.  # noqa: E501
        ...
        **Only for moderators+** Indicates if the rating has been moderated or not. If rating has been moderated, this value will be set to `true`. This value is not returned for normal services. Only moderators and admin roles will see it.   # noqa: E501
        ...
        :return: The moderated of this Rating.  # noqa: E501
        :rtype: bool
        """
    ...
    def moderated(self, moderated):
        """Sets the moderated of this Rating.

        **Only for moderators+** Indicates if the rating has been moderated or not. If rating has been moderated, this value will be set to `true`. This value is not returned for normal services. Only moderators and admin roles will see it.   # noqa: E501

        :param moderated: The moderated of this Rating.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def category(self):
        """Gets the category of this Rating.  # noqa: E501
        ...
        :return: The category of this Rating.  # noqa: E501
        :rtype: str
        """
    ...
    def category(self, category):
        ...
        :param category: The category of this Rating.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def sub_category(self):
        """Gets the sub_category of this Rating.  # noqa: E501
        ...
        :return: The sub_category of this Rating.  # noqa: E501
        :rtype: str
        """
    ...
    def sub_category(self, sub_category):
        """Sets the sub_category of this Rating.

        Sub category of the rated object. The external service should have a subset of given categories. These are not designed to be user-speficied categories. For example category with special characters (e.g. Jälkiruoka) does not work.   # noqa: E501

        :param sub_category: The sub_category of this Rating.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this Rating.

        URL of the rated object. For moderation purposes. Only moderators and admin roles will see it.   # noqa: E501

        :param url: The url of this Rating.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
