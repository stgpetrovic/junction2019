...
class Eans(object):
    ...
    def __init__(self, eans=None, local_vars_configuration=None):  # noqa: E501
        """Eans - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def eans(self):
        """Gets the eans of this Eans.  # noqa: E501


        :return: The eans of this Eans.  # noqa: E501
        :rtype: list[str]
        """
        return self._eans
    ...
    @eans.setter
    def eans(self, eans):
        """Sets the eans of this Eans.


        :param eans: The eans of this Eans.  # noqa: E501
        :type: list[str]
        """
        if self.local_vars_configuration.client_side_validation and eans is None:  # noqa: E501
            raise ValueError("Invalid value for `eans`, must not be `None`")  # noqa: E501
