...
class Payload(object):
    ...
    @property
    def items(self):
        """Gets the items of this Payload.  # noqa: E501


        :return: The items of this Payload.  # noqa: E501
        :rtype: list[PayloadItems]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this Payload.


        :param items: The items of this Payload.  # noqa: E501
        :type: list[PayloadItems]
        """
