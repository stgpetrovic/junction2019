...
class ItemBasketResponseBasketItems(object):
    ...
    """
    openapi_types = {
        'item': 'ItemBasketResponseBasketItemsItem'
    }
    ...
    def __init__(self, item=None, local_vars_configuration=None):  # noqa: E501
        """ItemBasketResponseBasketItems - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def item(self):
        """Gets the item of this ItemBasketResponseBasketItems.  # noqa: E501


        :return: The item of this ItemBasketResponseBasketItems.  # noqa: E501
        :rtype: ItemBasketResponseBasketItemsItem
        """
        return self._item

    @item.setter
    def item(self, item):
        """Sets the item of this ItemBasketResponseBasketItems.


        :param item: The item of this ItemBasketResponseBasketItems.  # noqa: E501
        :type: ItemBasketResponseBasketItemsItem
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ItemBasketResponseBasketItems):
            return False
