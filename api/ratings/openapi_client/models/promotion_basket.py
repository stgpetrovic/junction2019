...
class PromotionBasket(object):
    ...
    def __init__(self, size=None, base_eans=None, groups=None, local_vars_configuration=None):  # noqa: E501
        """PromotionBasket - a model defined in OpenAPI"""  # noqa: E501
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this PromotionBasket.

        Basket size ie. how many items from this basket should be bought for promotion to be valid.   # noqa: E501

        :param size: The size of this PromotionBasket.  # noqa: E501
        :type: float
        """
    ...
    @property
    def base_eans(self):
        """Gets the base_eans of this PromotionBasket.  # noqa: E501

        Array of base EAN codes included in the basket  # noqa: E501

        :return: The base_eans of this PromotionBasket.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def base_eans(self, base_eans):
        """Sets the base_eans of this PromotionBasket.

        Array of base EAN codes included in the basket  # noqa: E501

        :param base_eans: The base_eans of this PromotionBasket.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def groups(self):
        """Gets the groups of this PromotionBasket.  # noqa: E501

        Array of product groups included in the basket  # noqa: E501

        :return: The groups of this PromotionBasket.  # noqa: E501
        :rtype: list[str]
        """
        return self._groups
    ...
    def groups(self, groups):
        """Sets the groups of this PromotionBasket.

        Array of product groups included in the basket  # noqa: E501

        :param groups: The groups of this PromotionBasket.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PromotionBasket):
            return False
